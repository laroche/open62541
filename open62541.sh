...
if test "X$1" = Xinstall ; then
  if grep -q Debian /etc/os-release ; then
    sudo apt-get install git cmake make libmbedtls-dev python3-sphinx texlive-base python3-pkgconfig check # libssl-dev cmake-qt-gui arm-none-eabi-gcc
  else
...
if ! test -d open62541 ; then
  #git clone https://github.com/open62541/open62541
  git clone -b 1.4 https://github.com/open62541/open62541
  pushd open62541
    git config pull.rebase false
    patch -s -p1 < ../open62541.patch
...
if test "X$1" = Xpatch ; then
  pushd open62541
    git diff --ignore-submodules=dirty > ../open62541.patch2
    pushd deps/mdnsd
      git diff > ../../../open62541-mdnsd.patch2
    popd
  popd
  diff -u open62541.patch open62541.patch2
  diff -u open62541-mdnsd.patch open62541-mdnsd.patch2
  mv open62541.patch2 open62541.patch
